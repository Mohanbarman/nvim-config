...
vim.keymap.set('n', '<leader>dwf', function() widgets.centered_float(widgets.frames) end)
vim.keymap.set('n', '<leader>dws', function() widgets.centered_float(widgets.scopes) end)
